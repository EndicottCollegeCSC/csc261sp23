...
// Question 2: how do I make Pen generic? Specifically, I want to be 
//             able to specify any kind of Shape
public class Pen<T extends Shape> {
