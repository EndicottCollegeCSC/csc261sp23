...
//    private boolean isSelected;
    ...
    public boolean wasClicked(int x, int y){
        // Question 2: What code do we put here to call the 
        //  printMessage method in ShapeFarmer? "Checking for clicks!"
        ShapeFarmer.getInstance().printMessage("Checking for clicks from "+ System.identityHashCode(this) +"!");
